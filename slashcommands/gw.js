        ...
        return {
            ...
            options: [
                ...
                },
                {
                    name: 'apikey',
                    description:
                        'Add your personal GW2-API-Key to the bot, so that it can show you details from your account',
                    type: Discord.ApplicationCommandOptionType.Subcommand,
                    options: [
                        {
                            name: 'api-key',
